...
<h1 align="center" ;style = "color: pink">Hi! I'm Manya Sharma <img src="https://media.giphy.com/media/mGcNjsfWAjY5AEZNw6/giphy.gif" width="50"> </h1>
...
jobs:
  update-readme:
    ...
    steps:
      - uses: manya706/waka-readme-stats@master
        with:
          WAKATIME_API_KEY: ${{ secrets.waka_d7283f9d-05ba-4c5f-9cd6-4a00b19fa0ae }}
          GH_TOKEN: ${{ secrets.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 }}
<!--END_SECTION:waka-->
